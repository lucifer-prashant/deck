...
const TIPS = [
	...
	["Ctrl+B", "sidebar — explorer · git · outline"],
	["Ctrl+,", "preferences"],
...
const EmptyState: React.FC = () => {
	...
	const recent = tabs
		.filter(
			(t) => t.id !== activeTabId && Object.keys(t.panels || {}).length > 0,
		)
		...
		<div className="empty-state">
			<div className="empty-card welcome">
				<div className="welcome-head">
					...
					<div>
						<div className="empty-title">Deck</div>
						<div className="empty-sub">
							Spatial workspace — terminals, editors, browsers, notes on an
							infinite canvas.
						</div>
					</div>
				</div>
				...
				<div className="welcome-section">
					...
					<div className="empty-actions">
						<button
							className="quick-btn"
							onClick={() => executeWorkspaceCommand("new-terminal")}>
							<span className="empty-key">T</span>
							<span>Terminal</span>
						</button>
						<button
							className="quick-btn"
							onClick={() => executeWorkspaceCommand("new-editor")}>
							<span className="empty-key">E</span>
							<span>Editor</span>
						</button>
						<button
							className="quick-btn"
							onClick={() => executeWorkspaceCommand("new-browser")}>
							<span className="empty-key">B</span>
							<span>Browser</span>
						</button>
					</div>
				</div>
				...
				<div className="welcome-section">
					...
					<div className="empty-actions">
						<button
							className="quick-btn preset-life"
						...
						<button
							className="quick-btn preset-no-life"
							onClick={() => loadPreset("no-life")}>
							<span>⚒</span>
							<span>no-life</span>
							<span className="quick-sub">
								Gmail · LinkedIn · GitHub · Reddit · code · term
							</span>
						</button>
					</div>
				</div>
							...
							{recent.map((t) => (
								<button
									...
									<span className="recent-meta">
										{Object.keys(t.panels).length} panels
									</span>
								</button>
							))}
						</div>
