						...
						{SECTIONS.map((s) => (
							<button
								...
								style={{
									...
									border: "none",
									background:
										active === s.id ? "rgba(77,171,232,0.12)" : "transparent",
							...
							<div>
								<Field label="Snap grid step">
									<input
										...
										onChange={(e) =>
											updatePrefs({
												snapStep: parseInt(e.target.value, 10) || 20,
											})
										}
						...
						{active === "shortcuts" && (
							<div style={{ fontSize: 12 }}>
								<p style={{ opacity: 0.6, marginTop: 0 }}>
									Keyboard reference — see ? overlay for full list.
								</p>
								...
								<ShortcutRow
									keys="Ctrl+\\"
									label="Toggle chrome + status bar"
								/>
